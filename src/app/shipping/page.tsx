...
export default async function ShippingPage() {
  const settings = await fetchShippingSettings().catch(() => null);
  ...
  const points = [
    ...
    {
      icon: PackageCheck,
      title: `Free Shipping Above ${formatINR(freeThreshold)}`,
      description: `Orders under ${formatINR(freeThreshold)} carry a flat ${formatINR(flatRate)} shipping fee.`,
    },
    {
