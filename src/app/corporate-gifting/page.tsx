...
export default async function CorporateGiftingPage() {
  ...
  const heroImage = "/products/golden-crunch.jpg";

  return (
    <div>
      <PageHero
        image={heroImage}
        eyebrow="Gifting, Handled"
        title="Corporate Gifting"
        description="Handcrafted chocolate hampers for clients, teams, and festive occasions — with custom branding, ribbon, and card options for bulk orders."
        breadcrumbs={[{ label: "Home", href: "/" }, { label: "Corporate Gifting" }]}
      >
        <Button href="/contact" variant="filled">
          Enquire for Bulk Orders
        </Button>
        <Button href="/shop/customized-chocolates" variant="outline-light">
