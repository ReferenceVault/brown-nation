  ...
  return (
    ...
    >
      <div className="relative aspect-[4/3] w-full sm:aspect-auto sm:w-20 sm:shrink-0 md:w-24">
        <div className="relative h-full w-full overflow-hidden rounded-xl bg-white/50">
          {category.image && (
            <Image
              src={category.image}
              alt={category.name}
      ...
      <div className="flex min-w-0 flex-1 flex-col justify-center gap-0.5">
        ...
        {category.description && (
          <p className="text-xs sm:text-[11px] md:text-xs text-espresso/70 leading-snug line-clamp-1">
            {category.description}
          </p>
        )}
